...
CREATE TABLE departments (
    ...
    metadata JSON          -- New: JSON for flexible key-value storage
);

-- Employees table (many columns for overflow/scroll test; added skills as JSON array and performance_rating as DECIMAL)
CREATE TABLE employees (
    ...
    skills JSON,            -- New: JSON array for skills
    performance_rating DECIMAL(3,1),  -- New: decimal rating
...
CREATE TABLE timesheets (
    ...
    tags JSON,  -- JSON array for categorization
...
INSERT INTO timesheets (employee_id, task_name, date_worked, hours_worked, description, billable, tags) VALUES (1, 'Team Meeting', '2023-10-01', 2.0, 'Discussed sales targets', TRUE, '["meeting", "sales"]');
INSERT INTO timesheets (employee_id, task_name, date_worked, hours_worked, description, billable, tags) VALUES (2, 'Client Call', '2023-10-02', 1.5, 'Follow-up with Dwight Farms', TRUE, '["sales", "client"]');
INSERT INTO timesheets (employee_id, task_name, date_worked, hours_worked, description, billable, tags) VALUES (3, 'Prank Planning', '2023-10-03', 0.5, 'Ideas for office fun', FALSE, '["fun", "team"]');
INSERT INTO timesheets (employee_id, task_name, date_worked, hours_worked, description, billable, tags) VALUES (5, 'Budget Review', '2023-10-04', 3.0, 'Analyzed quarterly expenses', TRUE, '["accounting", "budget"]');
