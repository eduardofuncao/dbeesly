...
-- Enable foreign keys (optional, for referential integrity)
PRAGMA foreign_keys = ON;

-- Departments table (added budget as REAL and head_count as INTEGER for varied datatypes)
CREATE TABLE departments (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL,
    location TEXT NOT NULL,
    budget REAL,  -- REAL for decimal financial data
    head_count INTEGER,  -- INTEGER for counts
    metadata TEXT  -- TEXT for JSON-like strings
);

-- Employees table (many columns for overflow/scroll test; added skills as TEXT (JSON array) and performance_rating as REAL)
CREATE TABLE employees (
    ...
    email TEXT NOT NULL,
    phone TEXT,
    date_of_birth TEXT,  -- TEXT for ISO dates (e.g., '1964-03-15')
    hire_date TEXT NOT NULL,
    salary REAL,  -- REAL for precision
    office_number TEXT,
    ...
    skills TEXT,  -- TEXT for JSON array
    performance_rating REAL,  -- REAL for decimal rating
...
CREATE TABLE timesheets (
    ...
    description TEXT,
    billable INTEGER DEFAULT 1,  -- 1 for TRUE, 0 for FALSE
    tags TEXT,  -- TEXT for JSON array
