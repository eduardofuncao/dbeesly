-- Ensure we're writing into the intended database (Docker entrypoint already targets MARIADB_DATABASE, but this is explicit)
...
-- Insert packages (consistent list up to 'neofetch')
