...
-- MariaDB/MySQL dialect (converted from SQL Server T-SQL)
...
-- Employees table (many columns for overflow/scroll test; added skills as TEXT (JSON array) and performance_rating as DECIMAL)
...
CREATE TABLE timesheets (
    ...
    description TEXT,
    billable TINYINT(1) DEFAULT 1,  -- TINYINT(1) for boolean (1=TRUE, 0=FALSE)
